...
class NerBaseDict(object):
    ...
    def recognize(self, text):
        ...
        item["entities"] = [{"word":i, "type":"entity", "recog_label":"dict"} for i in final_wds]
...
class MedicalNerModel(object):
    ...
    def __init__(self):
        ...
        self.word2id,_,self.id2tag = pickle.load(
                open("D:\研一\代码\[baseline4]chatbot-model\knowledge_extraction\checkpoint\word_tag_id.pkl","rb")
            )
        self.model = BiLstmCrfModel(80,2410,200,128,10).build()
        self.model.load_weights(r'D:\研一\代码\[baseline4]chatbot-model\knowledge_extraction\checkpoint\best_bilstm_crf_model.h5')

        self.nbd = NerBaseDict(r'D:\研一\代码\[baseline4]chatbot-model\knowledge_extraction\checkpoint\diseases.json')
...
if __name__ == '__main__':
    ...
    ner = MedicalNerModel()
    # r = ner.predict(["阳明山国家级自然保护区属于哪种生态文明模式？"])
    # print(r)