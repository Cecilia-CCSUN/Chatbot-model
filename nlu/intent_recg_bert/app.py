...
class BertIntentModel(object):
    ...
    def __init__(self):
        ...
        self.dict_path = r'D:\chinese_bert_wwm_L-12_H-768_A-12\publish\vocab.txt'
        self.config_path = r'D:\chinese_bert_wwm_L-12_H-768_A-12\publish\bert_config.json'
        self.checkpoint_path = r'D:\chinese_bert_wwm_L-12_H-768_A-12\publish\bert_model.ckpt'
